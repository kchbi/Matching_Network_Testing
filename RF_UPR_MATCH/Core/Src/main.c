...
//
//		Motor_Set(MOTOR_1,2000);
//
//	    if (I2C_Init_INA226(&hi2c1, Pot1, 0x4FE6, 0x1000) != HAL_OK)
//	        printf("Failed to initialize Pot1/2 INA226\r\n");
//	    else{
//	    	printf("Pot1/2 INA226 initialized\r\n");
//	    }
//		if (I2C_WaitForConversionPolling(&hi2c1,  Pot1, 1024, 9.344f) != HAL_OK) {
...
//	    Motor_Set(MOTOR_2,-2000);
//
//	    if (I2C_Init_INA226(&hi2c1, Pot2, 0x4FE6, 0x1000) != HAL_OK)
//	        printf("Failed to initialize Pot1/2 INA226\r\n");
//	    else{
//	    	printf("Pot1/2 INA226 initialized\r\n");
//	    }
//		if (I2C_WaitForConversionPolling(&hi2c1,  Pot2, 1024, 9.344f) != HAL_OK) {
//		    printf("Polling timeout or I2C error!\r\n");
//		}
//	    I2C_ReadVoltage(&hi2c1,
//	                    Pot2,
//	                    &voltage1);
		...
		// 1. Wait for conversion to complete (polling)
//	    if (I2C_Init_INA226(&hi2c1, Pot1, 0x4FE6, 0x1000) != HAL_OK)
...
//
//
//		if (I2C_WaitForConversionPolling(&hi2c1, Pot1, 1024, 8.244f) != HAL_OK) {
//		    printf("Polling timeout or I2C error!\r\n");
//		}
//
//		// 2. Now safely read voltage data
//		float voltage1;
//		if (I2C_ReadVoltage(&hi2c1, Pot1, &voltage1) == HAL_OK) {
//			printf("Read the Voltage \r\n");
//
//		} else {
...
//		{
//			Motor_Set(MOTOR_1,i);
//			if (Pot1_2[0]-ADC_START > 10)
//			{
//				 PWM_START=i;
//			}
//			i=i+5;
//		}
//		MotorControl_MoveToADC(MOTOR_1,355,10);
//		HAL_Delay(1000);
//	    I2C_ReadVoltage(&hi2c1,
//	                    Pot1,
//	                    &voltage1);
//	    MotorControl_MoveToADC(MOTOR_1,1800,10);
//	    HAL_Delay(1000);
//	    MotorControl_MoveToADC(MOTOR_1,3190,10);
//	    HAL_Delay(1000);
//	    I2C_ReadVoltage(&hi2c1,
//	                    Pot1,
//	                    &voltage1);
