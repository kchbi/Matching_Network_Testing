...
/* Peripheral handles (CubeMX-generated) */
...
#define TOGGLE_M1_GPIO_Port GPIOA
#define STEP_M1_Pin GPIO_PIN_6
#define STEP_M1_GPIO_Port GPIOA
#define DIR_M1_Pin GPIO_PIN_7
#define DIR_M1_GPIO_Port GPIOA
#define STEP_M3_Pin GPIO_PIN_4
#define STEP_M3_GPIO_Port GPIOC
#define DIR_M3_Pin GPIO_PIN_5
#define DIR_M3_GPIO_Port GPIOC
#define STEP_M2_Pin GPIO_PIN_0
